---
description: digest 하나를 논문 세미나 발표 자료로 — 한 줄 메시지·스토리라인·막별 참고 대본·슬라이드별 그림·양단위 숫자표·비판·예상 질문 (wiki/queries/<slug>-seminar-prep.md)
---
...
2. `wiki/queries/<slug-short>-seminar-prep.md` (type: query) 에 쓴다 — 선례 `wiki/queries/kim2023-seminar-prep.md` 의 절 구조 그대로:
   0 한 줄 메시지 · 1 청중·시간 · 2 스토리라인 5막 · **2.5 막별 참고 대본**(막마다 여는 말/본문 3–4문장/넘기는 말/틀리기 쉬운 것, 슬라이드 범위·분 표기) · 3 슬라이드 표(제목 / 그림 파일·패널 / 말할 것 3 / 노트 / 분, ★ 표시로 15분 판) · 4 핵심 숫자표(**(S)·(Li2S) 양단위**, 로딩 병기) · 5 비판 3+3 · 6 우리 연구 연결 표 · 7 예상 질문 10 + 답(근거 위치) · 8 발표 체크리스트 · Status.
