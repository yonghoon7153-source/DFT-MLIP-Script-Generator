...
2. ~~모델을 고정하면 답은 좁다~~ — **철회.** "1 % 안 LAM_NE 폭 0.87 %p" 는
   ...
   고쳐 다시 뽑았다 — LAM_NE 3.6027 %p · LAM_PE 2.8696 · LLI 1.0832 (§3-3, `_v2`).
