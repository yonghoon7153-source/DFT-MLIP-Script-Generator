...
```
EXPECT_ZIP_SHA256      = c5ab1970d1f8fa8f60325db9f930cb1b17be93bcfa55cba94abd0aad5925eb83
EXPECT_MANIFEST_SHA256 = a01797bcf6ce28681637d6518b33e3c9c2d7bb3ab849654a99c427a4c123919c
```

```bash
sha256sum sdcp_c12_v37.zip          # 위 값과 대조 — 다르면 전송이 깨진 것입니다
mkdir -p <이 묶음 전용 빈 디렉터리> && cd <그 디렉터리>
unzip /경로/sdcp_c12_v37.zip && cd sdcp_c12_v37
...
export EXPECT_MANIFEST_SHA256=a01797bcf6ce28681637d6518b33e3c9c2d7bb3ab849654a99c427a4c123919c
export EXPECT_ZIP_SHA256=c5ab1970d1f8fa8f60325db9f930cb1b17be93bcfa55cba94abd0aad5925eb83
...
- **선택 attestation 함정 제거**: `MAKE_POTCAR_ATTESTATION.sh` 가 VASP stdout 전문을 적고 봉인은
  토큰만 담아, 돌리면 1단계를 다 돌린 뒤에야 판정이 막히는 결함(렌즈4 P0-1). 둘 다 토큰으로 통일했다.
- **δ_k 설계 제외의 근거를 비준 사전등록에 둔다** (안 v37). 재개 조건이 기계 평가 구조로
...
- walltime 문장 세 문서 통일 · 일정 4.14일(동시 4잡).
...
| | |
|---|---|
| 번들 | `runs/sdcp_c12_2026_08_30/sdcp_c12_v37.zip` |
| 증서 | `runs/sdcp_c12_2026_08_30/IDENTITY_v37.json` |
| 생성 커밋 | `a4e44636` (clean · 생성 시점에 origin 에 있던 커밋) |
