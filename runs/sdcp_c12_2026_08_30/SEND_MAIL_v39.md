...
```
EXPECT_ZIP_SHA256      = 8c8f4a0a017f2b1c6c1f989fc56c38a8ea9b60fb5e6645f44f42f65c62e1b639
EXPECT_MANIFEST_SHA256 = ca8eb30347029460feea1b65bcb4d701250e72a16547308a7166c5f159710253
```

```bash
sha256sum sdcp_c12_v39.zip          # 위 값과 대조 — 다르면 전송이 깨진 것입니다
mkdir -p <이 묶음 전용 빈 디렉터리> && cd <그 디렉터리>
unzip /경로/sdcp_c12_v39.zip && cd sdcp_c12_v39
...
export EXPECT_MANIFEST_SHA256=ca8eb30347029460feea1b65bcb4d701250e72a16547308a7166c5f159710253
export EXPECT_ZIP_SHA256=8c8f4a0a017f2b1c6c1f989fc56c38a8ea9b60fb5e6645f44f42f65c62e1b639
...
| | |
|---|---|
| 번들 | `runs/sdcp_c12_2026_08_30/sdcp_c12_v39.zip` |
| 증서 | `runs/sdcp_c12_2026_08_30/IDENTITY_v39.json` |
| 생성 커밋 | `57b50b8b` (clean · 생성 시점에 origin 에 있던 커밋) |
