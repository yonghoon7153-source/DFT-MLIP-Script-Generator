...
```
EXPECT_ZIP_SHA256      = 9621a438919a0e32083feb8a32587633e426ba52e2196b37399bdd2b19ff92b0
EXPECT_MANIFEST_SHA256 = a3121ba7517564216fef6b43758ee79369a35ac5d68a5a24f4eb8747adcac1bc
```

```bash
sha256sum sdcp_c12_v40.zip          # 위 값과 대조 — 다르면 전송이 깨진 것입니다
mkdir -p <이 묶음 전용 빈 디렉터리> && cd <그 디렉터리>
unzip /경로/sdcp_c12_v40.zip && cd sdcp_c12_v40
...
export EXPECT_MANIFEST_SHA256=a3121ba7517564216fef6b43758ee79369a35ac5d68a5a24f4eb8747adcac1bc
export EXPECT_ZIP_SHA256=9621a438919a0e32083feb8a32587633e426ba52e2196b37399bdd2b19ff92b0
...
| | |
|---|---|
| 번들 | `runs/sdcp_c12_2026_08_30/sdcp_c12_v40.zip` |
| 증서 | `runs/sdcp_c12_2026_08_30/IDENTITY_v40.json` |
| 생성 커밋 | `e992da73` (clean · 생성 시점에 origin 에 있던 커밋) |
