...
def _recommend(a, base, man, jobs, nk_cap, kpar_base, cap_h, nelm,
    ...
    추정은 ±2배라 그 판정이 반은 틀린다. 여기서는
      ① **천장**(NELM 횟수 상한 · 시간 보장 아님) 으로 코어/잡을 고르고
    ...
    print("   ⚠ '천장' 은 **전자스텝 횟수**(NELM)의 상한이지 시간의 보장이 아니다 — 스텝당 시간이 ±2배라 시간으로는 시나리오다. "
          "일수도 모형(±2배)이고 여기 일수는 LPT 가정(참고)이다. 어느 것도 계약 숫자로 쓰지 않는다 (Codex v37 P0-2 · R4 §3).")
